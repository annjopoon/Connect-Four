...
const int column1size = 6;
const int column2size = 7;
char tictacspace[6][7];
bool win;
...
int main()
{
	...
	while (answer == 'y')
	{
		...
		while (!win)
		{
			...
			while ((tictacspace[rowOptions - 1][columnOptions - 1] == 'X') || (tictacspace[rowOptions - 1][columnOptions - 1] == 'O'))
			{
